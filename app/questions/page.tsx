      ...
      <main className="flex min-h-screen flex-col items-center justify-center p-24 mt-8">
        ...
        <div className="mt-10 w-3/6">
          ...
          <div className="flex items-center justify-between mb-10 mt-4">
            <label className="text-xl font-sans text-gray-600">Are you above 55 years old?</label>
            <div className="flex items-center gap-4">
              <input type="checkbox" name="age" value="yes" style={{ transform: 'scale(1.3)' }}
                     checked={checkboxValues.age}
                     onChange={handleCheckboxChange}/>
            </div>
          </div>
          <div className="flex items-center justify-between mb-10 mt-4">
            <label className="text-xl font-sans text-gray-600">Do you have high cholesterol (above 200 mg/dL)?</label>
            <div className="flex items-center gap-4">
              <input type="checkbox" name="chol" value="yes" style={{ transform: 'scale(1.3)' }}
                     checked={checkboxValues.chol}
                     onChange={handleCheckboxChange}/>
            </div>
          </div>
          <div className="flex items-center justify-between mb-10 mt-4">
          ...
          <div className="flex items-center justify-between mb-10 mt-4">
            <label className="text-xl font-sans text-gray-600">Do you experience chest pains?</label>
            <div className="flex items-center gap-4">
              <input type="checkbox" name="chest_pains" value="yes" style={{ transform: 'scale(1.3)' }}
                     checked={checkboxValues.chest_pains}
                     onChange={handleCheckboxChange}/>
            </div>
          </div>
          <div className="flex items-center justify-between mb-10 mt-4">
            <label className="text-xl font-sans text-gray-600 mr-10">Do you experience chest pains post-exercise?</label>
            <div className="flex items-center gap-4">
              <input type="checkbox" name="chest_pains_exercise" value="yes" style={{ transform: 'scale(1.3)' }}
                     checked={checkboxValues.chest_pains_exercise}
                     onChange={handleCheckboxChange}/>
            </div>
          </div>
          <div className="flex items-center justify-between mb-10 mt-4">
